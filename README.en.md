...
- **Collaboration workspace**: integrate chat, tasks, board, assets, members, and settings. Explicitly dispatch work to an Agent and retain human task acceptance. Assets use administrator-configured customer storage; see the [collaboration guide](docs/collaboration.md).
