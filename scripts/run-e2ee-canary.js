...
if (process.platform !== 'win32') {
  throw new Error('The internal E2EE-TOFU Canary is currently limited to Windows test devices.');
}
...
summary.checks = [
  'readiness', 'core_protocol', 'browser_wasm', 'browser_lite_cross_process',
  'fake_im_faults', 'windows_canary_acceptance',
];
