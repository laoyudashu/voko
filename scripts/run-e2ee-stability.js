...
if (git('status', '--porcelain')) throw new Error('E2EE stability evidence requires a clean worktree');
...
if (git('status', '--porcelain')) throw new Error('Worktree changed during E2EE stability run');
