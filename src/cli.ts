...
const TOOL_PARAM_SCHEMAS = {
  ...
  list_conversations:      { agentId: 'string', filter: 'string', channelType: 'string', limit: 'number' },
  get_upload_url:          { filePath: 'string', fileName: 'string', contentType: 'string' },
  whoami:                  { ownerEmail: 'string' },
  ask_human_for_help:      { agentId: 'string', visitorId: 'string', problem: 'string', suggestion: 'string' },
  ...
  update_group:            { agentId: 'string', channelId: 'string', name: 'string', notice: 'string', avatar: 'string' },
};
