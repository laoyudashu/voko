 ...
 *
 * This is deliberately a one-time, non-guessing migration.  The native
 * session is never returned or persisted by this function; only its HMAC
 * fingerprint is written to the new identity table.
 */
...
module.exports = { AgentIdentityBindingStore, MessageRouteStore, RoutingConversationStore,
  ...
  backfillLegacyAgentIdentityBindings };
