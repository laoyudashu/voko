...
export class E2eeDirectoryClient {
  ...
  conversationStatuses(input: { agentIds: string[]; visitorIds: string[] }): Promise<any> {
    return this.request('/v1/e2ee/conversations/status', { method: 'POST', body: JSON.stringify(input) });
  }
