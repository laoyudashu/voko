...
| WorkBuddy | HTTP, Pull | WorkBuddy session ID | ACP streaming | Dispatcher | Requires separately installed and logged-in `@tencent-ai/codebuddy-code`; uncertain results are not resubmitted |
